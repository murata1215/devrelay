...
- **Devin CLI Integration**: Devin for Terminal support via spawn pattern (`devin -p --permission-mode dangerous`), stdin prompt, CLAUDE.md compatible — same architecture as Gemini/Codex/Aider
